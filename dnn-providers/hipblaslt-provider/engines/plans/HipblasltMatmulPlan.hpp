...
public:
    ...
    const HipblasltMatrixLayout& d() const;
...
private:
    static hipblasOperation_t getTrans(const hipdnn_data_sdk::data_objects::TensorAttributes& t);
    static hipblasComputeType_t
        getComputeDataType(const hipdnn_data_sdk::data_objects::MatmulAttributes& attributes);
    ...
    HipblasltMatrixLayout _matrixLayoutD;
    bool _tensorsValid;
};
